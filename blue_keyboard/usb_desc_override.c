////////////////////////////////////////////////////////////////////
// just a fancy to customize the usb stick appereance to os
////////////////////////////////////////////////////////////////////
#include "tusb.h"
#include <stdint.h>
...
static tusb_desc_device_t const desc_device = {
  ...
  .idVendor           = 0x303A,    // keep your current VID
  .idProduct          = 0x1001,    // keep your current PID so Windows treats it as same device
  .bcdDevice          = 0x0100,
  .iManufacturer      = 0x01,      // MUST be non-zero to use your strings
  .iProduct           = 0x02,
  .iSerialNumber      = 0x03,
...
uint16_t const * tud_descriptor_string_cb(uint8_t index, uint16_t langid)
{
  ...
  switch (index) {
    ...
    case 3: str = "BK-0015";           break;  // Bump to refresh cache
